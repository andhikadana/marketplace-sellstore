    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel"> 
        <ol class="carousel-indicators">
            <li data-target="details.phpcarouselExampleIndicators" data-slide-to="0" class="active"></li>
            <li data-target="details.phpcarouselExampleIndicators" data-slide-to="1"></li>
            <li data-target="details.phpcarouselExampleIndicators" data-slide-to="3"></li>
        </ol>
